...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cleanResultTextBtn).setOnClickListener(this);

        mTextView = (TextView) findViewById(R.id.httpResponseTextView);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.httpGetBtn:
                new HttpRequestAsync().execute(text);
                break;
            case R.id.cleanResultTextBtn:
                mTextView.setText("");
                break;
        }
    }

    class HttpRequestAsync extends AsyncTask<String, Integer, String> {
        protected String doInBackground(String... urls) {
            return HttpRequest.getUrlResponseMessage(urls[0]);
        }

        protected void onPostExecute(String result) {
            Log.d("HttpRequestAsync", "onPostExecute:  " + result);
